...
//@brief Lit une séquence d'ordres saisie par l'utilisateur via l'entrée
//standard.
...
//@param[in]     sequence Chaîne de caractères contenant la suite d'ordres (ex:
//"KILOMA").
...
//@return 1 si les positions sont identiques(mêmes animaux, même ordre), 0
//sinon.

/**
 * @brief Copie l'état d'une position source vers une destination.
 */
